"""
This module takes Yahoo or WSJ data and transforms it into a normalized pandas dataframe
"""
import pandas as pd

def normalizer(csv):
    """
    Python class to download and convert raw data into normalized CSV file
    """
